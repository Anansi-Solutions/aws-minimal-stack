...
### `__GITHUB_ACCOUNT__` and `__GITHUB_REPO__`

For a GitHub repository like `Anansi-Solutions/aws-minimal-stack`, these are respectively
the name of the GitHub account (`Anansi-Solutions`) and
the name of the repo within that account (`aws-minimal-stack`).
